...
### ⚡ **智能下载引擎**
- 🚀 **Dlmily模式** - 290章/批次，极速下载
- 🐰 **rabbits0209模式** - 智能章节限制，稳定可靠
- 📊 **章节限制** - 可配置最大章节数，自动分批下载
- 🔄 **断点续传** - 支持暂停恢复，避免重复
- 🌐 **多API源** - 自动切换，确保稳定性
- 🎯 **智能重试** - 失败自动重试，成功率更高
...
| ⚡ **Dlmily模式** | 支持290章/批次的高速下载 | ✅ 完成 |
| 🐰 **rabbits0209模式** | 智能章节限制，可配置最大章节数 | ✅ 完成 |
...
```json
{
    "request": {
        ...
        "single_batch_size": 100,             // 📦 rabbits0209批量大小 (5-100)
        "rabbits0209_max_chapters": 31,       // 📊 章节限制 (1-100)
        "rabbits0209_enable_limit": true      // 🔒 启用章节限制
    }
}
```
...
**🐰 rabbits0209模式配置**
- **章节限制**: `rabbits0209_max_chapters: 31` (推荐值，可根据需要调整1-100)
- **启用限制**: `rabbits0209_enable_limit: true` (建议启用以提高稳定性)
- **批量大小**: `single_batch_size: 100` (与章节限制协调使用)
- **使用场景**: 适合需要稳定下载的场景，自动分批处理大量章节
...
#### **🏆 特别感谢**
- 🎯 **[Dlmily](https://github.com/Dlmily)** - 提供核心算法参考和Dlmily下载节点
- 👍 **[rabbits0209](https://github.com/rabbits0209)** - 提供rabbits0209下载节点
- 🌟 **所有贡献者** - 代码贡献和问题反馈
- 🛠️ **开源社区** - 提供优秀的库和工具
- 👥 **用户群体** - 宝贵的使用反馈和建议
